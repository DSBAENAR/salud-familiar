...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-[#0f172a] text-white transition-transform duration-300 lg:translate-x-0 lg:z-30",
      ...
      >
        ...
        <div className="flex flex-col gap-1 px-6 pt-8 pb-6">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={close}
              className="lg:hidden rounded-lg p-1 text-slate-400 hover:text-white hover:bg-white/10 transition-colors"
            >
              <X className="size-5" />
            </button>
          </div>
